...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        @foreach($universities as $university)
            <div
                class="bg-gray-800 rounded-lg border border-gray-700 overflow-hidden hover:bg-gray-750 transition-colors">

                <!-- University Image with Logo Overlay -->
                <div class="relative h-40 bg-gradient-to-br from-gray-700 to-gray-900">
                    ...
                    @else
                        <div class="w-full h-full flex items-center justify-center text-gray-500 text-6xl">
                            🎓
                        </div>
                    @endif
                    ...
                    @if($university->logo_url)
                        <div class="absolute top-3 right-3 w-12 h-12 bg-white rounded-full shadow-lg p-1.5">
                    ...
                    @if($university->ranking)
                        <div
                            class="absolute top-3 left-3 bg-yellow-400 text-gray-900 px-2 py-1 rounded-full font-bold text-xs shadow-lg">
                            🏆 #{{ $university->ranking }}
                        </div>
                    @endif
                </div>
