                ...
                <div class="space-y-3">
                    @if($university->ranking)
                        <div class="flex items-center text-gray-300">
                            ...
                            <span class="text-sm">Rank #{{ $university->ranking }}</span>
                        </div>
                    @endif

                    <p class="text-gray-400 text-sm line-clamp-3">
                        {{ Str::limit($university->description ?? 'No description available', 120) }}
                    </p>
                    ...
                    <div class="flex items-center justify-between pt-3 border-t border-gray-700">
                        ...
                        <span class="text-xs text-gray-400">
                            Created:
                            {{ $university->created_at ? $university->created_at->format('M d, Y') : 'N/A' }}
                        </span>
                    </div>
                </div>
            </div>
