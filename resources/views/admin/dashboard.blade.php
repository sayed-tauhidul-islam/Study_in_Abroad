...
<div class="space-y-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <a href="{{ route('admin.degrees.index') }}"
            class="block bg-gray-800 p-6 rounded-lg border border-gray-700 hover:bg-gray-700 transition-colors group">
            <div class="flex items-center justify-between mb-4">
                <h2 class="font-bold text-xl text-white">Degrees</h2>
                <svg class="w-6 h-6 text-pink-400 group-hover:text-pink-300" fill="none" stroke="currentColor"
                    viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <p class="text-gray-400 mb-4">Manage degree programs</p>
            <div class="flex space-x-2">
                <span class="bg-red-600 text-white px-3 py-1 rounded-full text-sm">Add</span>
                <span class="bg-blue-600 text-white px-3 py-1 rounded-full text-sm">Edit</span>
                <span class="bg-red-800 text-white px-3 py-1 rounded-full text-sm">Delete</span>
        ...
        <a href="{{ route('admin.suggestions.index') }}"
            class="block bg-gray-800 p-6 rounded-lg border border-gray-700 hover:bg-gray-700 transition-colors group">
            <div class="flex items-center justify-between mb-4">
                <h2 class="font-bold text-xl text-white">Suggestions</h2>
                <svg class="w-6 h-6 text-orange-400 group-hover:text-orange-300" fill="none" stroke="currentColor"
                    viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <p class="text-gray-400 mb-4">View user suggestions and feedback</p>
            <div class="flex space-x-2">
                <span class="bg-green-600 text-white px-3 py-1 rounded-full text-sm">View</span>
                <span class="bg-blue-600 text-white px-3 py-1 rounded-full text-sm">Mark Read</span>
                <span class="bg-red-800 text-white px-3 py-1 rounded-full text-sm">Delete</span>
            </div>
        </a>
    </div>
