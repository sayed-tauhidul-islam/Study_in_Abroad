...
@section('content')
<!-- Hero Section -->
<section class="relative bg-white py-20 border-b-4 border-pink-500">
    <div class="container mx-auto px-4 text-center">
        <h1 class="text-5xl font-extrabold text-blue-900 mb-6 drop-shadow-lg">About StudyAbroad</h1>
        <p class="text-xl text-blue-700 mb-8 max-w-3xl mx-auto">Your trusted partner in international education,
            connecting
    ...
    <div class="container mx-auto px-4">
        <div class="grid md:grid-cols-2 gap-12 items-center">
            <div>
                ...
                <p class="text-lg text-blue-700 mb-6 leading-relaxed">
                ...
                <div class="flex items-center space-x-6">
                    <div class="text-center">
                        <div class="text-3xl font-bold text-pink-600">14+</div>
                        <div class="text-sm text-blue-700">Years of Experience</div>
                    </div>
                    <div class="text-center">
                        <div class="text-3xl font-bold text-green-600">50K+</div>
                        <div class="text-sm text-blue-700">Students Helped</div>
                    </div>
                    <div class="text-center">
                        <div class="text-3xl font-bold text-blue-600">500+</div>
                        <div class="text-sm text-blue-700">Partner Universities</div>
                    </div>
                </div>
            </div>
            <div class="relative">
                <img src="https://images.unsplash.com/photo-1522202176988-66273c2fd55f?auto=format&fit=crop&w=800&q=80"
                    alt="Our Team" class="rounded-2xl shadow-2xl border-4 border-white">
                <div class="absolute -bottom-6 -right-6 bg-white p-4 rounded-xl shadow-lg border-2 border-pink-500">
                    <div class="flex items-center space-x-3">
                        <div
                            class="w-12 h-12 bg-gradient-to-br from-pink-500 to-blue-600 rounded-full flex items-center justify-center text-white font-bold">
                            S</div>
                        <div>
                            <div class="font-semibold text-blue-900">StudyAbroad Team</div>
                            <div class="text-sm text-blue-700">Dedicated Professionals</div>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="py-20 bg-white">
    <div class="container mx-auto px-4">
        <div class="text-center mb-16">
            <h2 class="text-4xl font-bold text-blue-900 mb-4">Our Mission & Vision</h2>
            <p class="text-xl text-blue-700 max-w-3xl mx-auto">Guiding principles that drive everything we do</p>
        </div>
        <div class="grid md:grid-cols-2 gap-12">
            <div
                class="bg-white p-8 rounded-2xl shadow-lg border-l-4 border-blue-500">
            ...
            <div
                class="bg-white p-8 rounded-2xl shadow-lg border-l-4 border-green-500">
                <div class="text-6xl mb-6">🌟</div>
...
<section class="py-20 bg-white">
    <div class="container mx-auto px-4">
        <div class="text-center mb-16">
            <h2 class="text-4xl font-bold text-blue-900 mb-4">What Sets Us Apart</h2>
            <p class="text-xl text-blue-700 max-w-3xl mx-auto">Why thousands of students choose StudyAbroad</p>
        </div>
        <div class="grid md:grid-cols-3 gap-8">
            <div
                ...
                <p class="text-blue-700">Every student receives customized guidance based on their unique profile,
            ...
            <div
                ...
                <p class="text-blue-700">Access to thousands of scholarships and financial aid opportunities to make
                    education affordable.</p>
            </div>
            <div
                class="bg-white p-8 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 text-center">
                <div class="text-6xl mb-6">🌍</div>
                <h3 class="font-bold text-xl mb-3 text-pink-700">Global Network</h3>
                <p class="text-blue-700">Strong partnerships with universities worldwide and extensive alumni network
            ...
            <div
                ...
                <p class="text-blue-700">Complete assistance from application to arrival, including visa guidance and
            ...
            <div
                ...
                <p class="text-blue-700">Team of experienced education consultants with firsthand knowledge of
            ...
            <div
                ...
                <p class="text-blue-700">95% success rate with thousands of students successfully placed in top
...
<section class="py-20 bg-white">
    <div class="container mx-auto px-4">
        <div class="text-center mb-16">
            <h2 class="text-4xl font-bold text-blue-900 mb-4">Meet Our Leadership Team</h2>
            <p class="text-xl text-blue-700 max-w-3xl mx-auto">Experienced professionals dedicated to your success</p>
        </div>
        <div class="grid md:grid-cols-3 gap-8">
            <div class="text-center bg-white p-8 rounded-2xl shadow-lg">
                ...
                <p class="text-pink-600 font-semibold mb-3">Chief Executive Officer</p>
                <p class="text-blue-700 text-sm">15+ years in international education, former Harvard admissions officer
                </p>
            </div>
            <div class="text-center bg-white p-8 rounded-2xl shadow-lg">
                ...
                <p class="text-pink-600 font-semibold mb-3">Chief Operating Officer</p>
                <p class="text-blue-700 text-sm">12+ years in student services, MBA from University of Toronto</p>
            </div>
            <div class="text-center bg-white p-8 rounded-2xl shadow-lg">
                ...
                <h3 class="font-bold text-xl mb-2 text-pink-700">Dr. Sarah Ahmed</h3>
                <p class="text-pink-600 font-semibold mb-3">Director of Counseling</p>
                <p class="text-blue-700 text-sm">PhD in Education, specializes in career guidance and university
                    admissions</p>
            </div>
        </div>
    </div>
...
<!-- Our Values -->
<section class="py-20 bg-white border-t-4 border-b-4 border-blue-500">
    <div class="container mx-auto px-4">
        <div class="text-center mb-16">
...
<!-- Contact CTA -->
<section class="py-20 bg-white border-t-4 border-pink-500">
    <div class="container mx-auto px-4 text-center">
