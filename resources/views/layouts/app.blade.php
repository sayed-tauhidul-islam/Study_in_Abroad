...
<body class="bg-gradient-to-br from-blue-50 to-indigo-100 min-h-screen">
    ...
    <!-- Footer -->
    <footer class="bg-gray-800 text-white py-16 mt-16 relative overflow-hidden border-t border-gray-700">
        <!-- Background Pattern -->
            ...
            <div class="grid md:grid-cols-5 gap-8">
                <div class="md:col-span-2">
                    <h3 class="text-2xl font-bold mb-4 flex items-center">
                        <span class="text-white mr-2">🌍</span> StudyAbroad
                    </h3>
                    <p class="text-gray-300 mb-6 leading-relaxed">Your gateway to international education opportunities.
                        Discover universities, scholarships, and courses worldwide to shape your future.</p>
                    <!-- Newsletter Signup -->
                    <div class="bg-gray-700 rounded-lg p-4 border border-gray-600">
                        <h5 class="font-semibold mb-2 text-white">Stay Updated</h5>
                        <div class="flex">
                            <input type="email" placeholder="Enter your email"
                                class="flex-1 px-3 py-2 rounded-l-md text-gray-800 focus:outline-none border border-gray-500">
                            <button
                    ...
                    <div class="flex space-x-4 mt-6">
                        <a href="#"
                            class="bg-gray-700 hover:bg-gray-600 p-3 rounded-full transition-all duration-300 hover:scale-110 hover:shadow-lg group"
                            title="Facebook">
                            <svg class="w-6 h-6 text-gray-300 group-hover:text-blue-400" fill="currentColor"
                                viewBox="0 0 24 24">
                                <path
                        ...
                        <a href="#"
                            class="bg-gray-700 hover:bg-gray-600 p-3 rounded-full transition-all duration-300 hover:scale-110 hover:shadow-lg group"
                            title="Instagram">
                            <svg class="w-6 h-6 text-gray-300 group-hover:text-pink-400" fill="currentColor"
                                viewBox="0 0 24 24">
                                <path
                        ...
                        <a href="#"
                            class="bg-gray-700 hover:bg-gray-600 p-3 rounded-full transition-all duration-300 hover:scale-110 hover:shadow-lg group"
                            title="WhatsApp">
                            <svg class="w-6 h-6 text-gray-300 group-hover:text-green-400" fill="currentColor"
                                viewBox="0 0 24 24">
                                <path
                        ...
                        <a href="#"
                            class="bg-gray-700 hover:bg-gray-600 p-3 rounded-full transition-all duration-300 hover:scale-110 hover:shadow-lg group"
                            title="YouTube">
                            <svg class="w-6 h-6 text-gray-300 group-hover:text-red-500" fill="currentColor"
                                viewBox="0 0 24 24">
                                <path
                        ...
                        <a href="#"
                            class="bg-gray-700 hover:bg-gray-600 p-3 rounded-full transition-all duration-300 hover:scale-110 hover:shadow-lg group"
                            title="LinkedIn">
                            <svg class="w-6 h-6 text-gray-300 group-hover:text-blue-500" fill="currentColor"
                                viewBox="0 0 24 24">
                                <path <!-- Smooth scroll for nav links -->
                                    <script>
